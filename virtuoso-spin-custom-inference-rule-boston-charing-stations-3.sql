...
TTLP ('
	...
	spin:rule
	          [ a sp:Construct, spin:Rule ;
	            ...
	            rdfs:comment """Handler for different kinds of Latitude oriented fields (relations). This particular rule
								has been loaded into Virtuoso via SQL (using SPASQL functionality)""" ;
	            sp:text """
	...
	spin:rule
	          ...
	          [ a sp:Construct, spin:Rule;
	            ...
	            rdfs:comment """Handler for different kinds of Longitude oriented fields (relations). This particular rule
								has been loaded into Virtuoso via SQL (using SPASQL functionality)""" ;
	            sp:text """
...
SPARQL 
SELECT  COUNT (*) 
FROM <urn:spin:rule:geospatial:lib4> WHERE {?s ?p ?o} ;
