-- SQL rendition of Social Network Relations for Graph Analytics
-- using SQL-Transitivity extension

DROP TABLE demo..knows ;

CREATE TABLE demo..knows ( subject VARCHAR ,
                           object VARCHAR ,
                           PRIMARY KEY ( subject , object )
                         ) ;
ALTER INDEX knows
      ON demo..knows
      PARTITION ( subject VARCHAR ) ;

CREATE INDEX knows2
       ON demo..knows ( object, subject )
       PARTITION ( object VARCHAR ) ;

-- <a> foaf:knows <urn:b> , <urn:c> , <urn:d> , <urn:e> , <urn:f> , <urn:m> , <urn:g> .
